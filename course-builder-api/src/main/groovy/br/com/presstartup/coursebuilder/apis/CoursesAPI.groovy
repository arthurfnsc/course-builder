...
class CoursesAPI implements CoursesApi {
    ...
    /* (non-Javadoc)
     * @see br.com.presstartup.coursebuilder.swagger.api.CoursesApi#coursesGet(java.lang.String, java.math.BigDecimal)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see br.com.presstartup.coursebuilder.swagger.api.CoursesApi#coursesIdentifierChaptersItemsPut(java.lang.String, java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see br.com.presstartup.coursebuilder.swagger.api.CoursesApi#coursesIdentifierChaptersPost(java.lang.String, br.com.presstartup.coursebuilder.swagger.model.Chapter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see br.com.presstartup.coursebuilder.swagger.api.CoursesApi#coursesIdentifierGet(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see br.com.presstartup.coursebuilder.swagger.api.CoursesApi#coursesIdentifierPut(java.lang.String, br.com.presstartup.coursebuilder.swagger.model.Course)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see br.com.presstartup.coursebuilder.swagger.api.CoursesApi#coursesPost(br.com.presstartup.coursebuilder.swagger.model.Course)
     */
    @Override
